...
local DiscreteBestResponse = require 'alg.DiscreteBestResponse'
...
function main()
	...
	local agent1 = DiscreteBestResponse.new(model1, policy1, optimizer1, 1) -- this is agent 1
	local agent2 = DiscreteBestResponse.new(model2, policy2, optimizer2, 2) -- this is agent 2
