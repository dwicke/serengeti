--[[
This produces very good results (around -8, -8 by step 1000) with the following parameters
...
function makeModel(learningRate, alr, vlr)
  ...
  agent1:initiateParameters(-10.5,-10.)
  agent1:setAdditionalLearningRate(alr, vlr)
  agent1:setActionStdev(5.5)
  ...
  agent2:initiateParameters(-10.5,-10.)
  agent2:setAdditionalLearningRate(alr, vlr)
  agent2:setActionStdev(5.5)
...
function main()
  local agent1, agent2 = makeModel(0.3, 0.0005, 0.005)
